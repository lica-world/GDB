...
from gdb.utils.data_helpers import load_task_json
from gdb.utils.template_layout_paths import (
    load_layout_content,
    parse_data_root,
    resolve_layout_paths,
)
from gdb.utils.text_helpers import parse_json_from_text, strip_thinking
