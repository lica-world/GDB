"""Typography benchmarks: typography-1 through typography-8 (+ image-6).
...
``load_data``, e.g. ``data/gdb-dataset``), not only against ``data_dir``.
"""
...
from gdb.utils.text_helpers import extract_json_obj
...
class StyledTextGeneration(BaseBenchmark):
    ...
    USE_MANIFEST_PROMPT_ENV = "GDB_G10_USE_MANIFEST_PROMPT"
    TEXTPARAM_API_URL_ENV = "GDB_G10_TEXTPARAM_API_URL"
    TEXTPARAM_API_KEY_ENV = "GDB_G10_TEXTPARAM_API_KEY"
    TEXTPARAM_API_TIMEOUT_ENV = "GDB_G10_TEXTPARAM_API_TIMEOUT_SECONDS"
    TEXTPARAM_API_MODEL_ID_ENV = "GDB_G10_TEXTPARAM_API_MODEL_ID"
    TEXTPARAM_API_GCS_BUCKET_ENV = "GDB_G10_TEXTPARAM_GCS_BUCKET"
    TEXTPARAM_API_GCS_PREFIX_ENV = "GDB_G10_TEXTPARAM_GCS_PREFIX"
    TEXTPARAM_API_GCS_CREDENTIALS_ENV = "GDB_G10_TEXTPARAM_GCS_CREDENTIALS"
    ...
    BBOX_DETECTOR_MODEL_ID_ENV = "GDB_G10_BBOX_DETECTOR_MODEL_ID"
    ...
    def _maybe_load_text_param_predictor(cls) -> Any:
        ...
        model_dir_env = os.environ.get("GDB_G10_TEXTPARAM_MODEL_DIR", "").strip()
        ...
        try:
            ...
            backbone = os.environ.get("GDB_G10_TEXTPARAM_BACKBONE", "").strip()
            if backbone:
    ...
    def _maybe_upload_textparam_patch_to_gcs(cls, image: np.ndarray) -> str:
        ...
        if not bucket:
            return ""
        prefix = str(
            os.environ.get(cls.TEXTPARAM_API_GCS_PREFIX_ENV, "gdb/g10-textparam")
        ).strip("/")
        ...
        try:
            ...
            from gdb.inference.gcs import upload_file_public
        except Exception as exc:  # noqa: BLE001
...
class MixedStyleTextGeneration(BaseBenchmark):
    ...
    def build_model_input(self, sample: Dict[str, Any], *, modality: Any = None) -> Any:
        from gdb.models.base import Modality, ModelInput
...
# ===========================================================================
# image-6 (Text Removal) — implemented in typography domain module
# ===========================================================================
